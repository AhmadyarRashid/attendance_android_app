                        ...
                        try {
                            ...
                            if (json.getBoolean("isSuccess")) {
                                ...
                                if (disable.equals("checkIn")) {
                                    ...
                                    checkOutBtn.setBackgroundColor(getResources().getColor(R.color.bg));
                                    checkInBtn.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                                }
                                if (disable.equals("checkOut")) {
                                    checkInBtn.setEnabled(false);
                                    checkOutBtn.setEnabled(true);
                                    checkOutBtn.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                                    checkInBtn.setBackgroundColor(getResources().getColor(R.color.bg));
                                }
